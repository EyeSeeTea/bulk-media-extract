# current-data-element-properties Specification

## Purpose
Expose current data element metadata (name and code) as template properties so that export file paths can include data-element-level tokens.
## Requirements
