...
const TEMPLATE_TOKEN =
    /\{(?:orgUnitName|orgUnitId|orgUnitCode|orgUnitShortName|orgUnitPath|orgUnitLevel|enrollmentDate|eventId|fileName|fileExtension|fileDataElementId|fileDataElementName|fileProgramStageId|fileProgramStageName|fileValueType|currentDataElementName|currentDataElementCode|attribute:[A-Za-z0-9_-]+|dataElement:[A-Za-z0-9_-]+|orgUnitAttribute:[A-Za-z0-9_-]+)\}/g;
